...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: "/admin/traffic-simulation",
    title: "Traffic Simulation Analysis",
    type: "link",
    icontype: "fas fa-tasks text-default",
  },
  {
    path: "/admin/road-congestion",
    title: "Road Congestion Map",
    type: "link",
  ...
  },
  {
    ...
    isCollapsed: true,
    children: [
      { path: "social-analysis", title: "Social Analysis", type: "link" },
      { path: "media-monitoring", title: "Media Monitoring", type: "link" },
    ],
  },
  // {
  //   path: "/admin/bill",
