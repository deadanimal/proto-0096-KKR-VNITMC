...
@Component({
  selector: "app-road-congestion-map",
  templateUrl: "./road-congestion-map.component.html",
  styleUrls: ["./road-congestion-map.component.scss"],
})
export class RoadCongestionMapComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  getChart() {
    ...
    series.tooltipText = "{categoryX} (2004): [bold]{valueY}[/]";
    ...
    series2.tooltipText = "{categoryX} (2005): [bold]{valueY}[/]";
